...
# you cna put that endpoint in a browser to see the error 
...
def handle_book(book_id):                              # RESTful convensions this says that we want to get one item from a resource, the name in the funct should match
    #book_by_id = {}                                     # the params def, note that the data passed into the param on line 72 will be a string we must convert or else
